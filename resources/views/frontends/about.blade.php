...
<head>
    ...
    <title>Tentang || AS Leather</title>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Tentang Kita</h2>
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" href="/">Beranda</a>
                                  <span class="brd-separetor">/</span>
                                  <span class="breadcrumb-item active">Tentang Kita</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section__title section__title--2 text-center">
                            ...
                            <p>AS Leather merupakan sebuah perusahaan yang membuat mulai dari dompet kulit dan tas kulit yang berkualitas</p>
                        </div>
