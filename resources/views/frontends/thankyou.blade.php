        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <a href="/index" class="js-logo-clone">AS Leather Shoppers</a>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
            ...
            <a href="#" class="block-6">
              <img src="{{ asset('assets/frontend/images/hero_1.jpg') }}" alt="Image placeholder" class="img-fluid rounded mb-4">
