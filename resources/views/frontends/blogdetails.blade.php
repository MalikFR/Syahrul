...
<head>
    ...
    <title>Lihat Artikel || AS Leather</title>
                                ...
                                <ul class="main__menu">
                                    ...
                                    <li class="drop"><a href="/blog">Artikel</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="/blogdetails">Lihat Artikel</a></li>
                                        </ul>
                                    </li>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="bradcaump__inner text-center">
                                <h2 class="bradcaump-title">Lihat Artikel</h2>
                                <nav class="bradcaump-inner">
                                  <a class="breadcrumb-item" href="/">Beranda</a>
                                  <span class="brd-separetor">/</span>
                                  <span class="breadcrumb-item active">Lihat Artikel</span>
                                </nav>
                            </div>
                        </div>
                    </div>
