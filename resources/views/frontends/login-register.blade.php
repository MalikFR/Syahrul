...
<!-- Mirrored from demo.devitems.com/uniqlo//login-register by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Nov 2018 04:41:05 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>LogIn Ragister || Uniqlo-Minimalist eCommerce HTML5 Template</title>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-2 col-lg-2 col-sm-3 col-xs-3">
                            <div class="logo">
                                <a href="/">
                                    <img src="{{ asset('/assets/frontend/uniqlo/images/logo/uniqlo.pn')}}g" alt="logo">
                                </a>
                            </div>
                        </div>
                        <!-- Start MAinmenu Ares -->
                                ...
                                <ul class="main__menu">
                                    ...
                                    <li class="drop"><a href="#">pages</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="/shop">shop</a></li>
                                            <li><a href="">shop sidebar</a></li>
                                            <li><a href="/detailproduk">product details</a></li>
                                            <li><a href="/cart">cart</a></li>
                                            <li><a href="">wishlist</a></li>
                                            <li><a href="/checkout">checkout</a></li>
                                            <li><a href="">team</a></li>
...
<!-- Mirrored from demo.devitems.com/uniqlo//login-register by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 Nov 2018 04:41:11 GMT -->
</html>