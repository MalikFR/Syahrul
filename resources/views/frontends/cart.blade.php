...
<head>
    ...
    <title>Keranjang || AS Leather</title>
                        ...
                        <div class="shp__cart__wrap">
                            <div class="shp__single__product">
                                ...
                                <div class="shp__pro__details">
                                    ...
                                    <span class="shp__price">{{ number_format($data->produks->price,2,',','.')}}</span>
                                </div>
                            ...
                            <form method="post" action="{{url('cart/edit/'.Auth::user()->id)}}">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="product-thumbnail"><a href="#"><img src="{{asset('assets/img/barang/' . $data->produks->cover)}}" alt="product img" /></a></td>
                                            <td class="product-name"><a href="#">{{$data->produks->title}}</a></td>
                                            <td class="product-price"><span class="amount">Rp. {{ number_format($data->produks->price,2,',','.')}}</span></td>
                                        <td class="product-quantity"><input type="number" name="jumlah_brg[]" value="{{$data->jumlah_brg}}" /></td>
                                            <td class="product-subtotal">Rp.{{number_format($data->jumlah_brg * $data->produks->price,2,',','.')}}</td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-5 col-xs-12">
                                    <div class="cart_totals">
                                        <h2>Keranjang Totals</h2>
                                        <table>
                                            <tbody>
                                                <tr class="cart-subtotal">
                                                    <th>Subtotal</th>
                                                    <td><span class="amount">Rp. {{number_format($total_all,2,',','.')}}</span></td>
                                                </tr>
